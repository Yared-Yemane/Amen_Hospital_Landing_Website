...
const machines = [
  {
    ...
    description:
      "A medical imaging technique used in an operation performed in the abdomen or pelvis using small incisions.",
  ...
  },
  {
    ...
    description:
      "A diagnostic imaging procedure that uses x-rays to create detailed pictures of structures inside the body.",
  ...
  },
  {
    ...
    description:
      "A quick and effective method for viewing the inside of the body, often used for detecting internal fractures.",
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto py-10">
      <Swiper
        ...
        breakpoints={{
          768: {
            slidesPerView: 1, // Show 1 slide on tablets and below
          },
        }}
      >
        {machines.map((machine) => (
          <SwiperSlide key={machine.id}>
            <div className="flex bg-white dark:bg-[#2d3748] rounded-lg shadow-lg overflow-hidden border dark:border-[#4a5568]">
              {/* Left Section - Image */}
              <div className="w-1/2">
                <img
                  src={machine.image}
