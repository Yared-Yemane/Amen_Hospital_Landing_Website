...
const AboutHero = () => {
  return (
    <div className="bg-white dark:bg-gray-900 grid grid-cols-1 md:grid-cols-2 pb-20 px-16 pt-14">
      <div>
        <img
          src="/images/about/about.png"
          className="rounded-lg object-cover h-full w-3/4"
          alt="About Us"
        />
      </div>
      ...
      <div className="w-full">
        ...
        <h1 className="text-[46px] font-bold mt-4 leading-tight mb-6 text-gray-900 dark:text-white">
        ...
        <div className="flex gap-4 mt-4">
          {aboutCards.map((card, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center p-6 rounded-lg bg-[#e3e2ff] dark:bg-[#2d3748] w-36 h-36"
            >
