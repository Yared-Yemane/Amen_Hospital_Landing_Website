  ...
  return (
    <div className="py-16 px-4 sm:px-8 dark:bg-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Hygiene Guidelines */}
        <div className="bg-white shadow-lg rounded-lg p-8 hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:shadow-xl dark:hover:shadow-2xl">
          ...
          <ul className="list-disc pl-6 space-y-4">
            <li className="text-lg text-gray-700 dark:text-gray-300 hover:text-blue-600 hover:scale-105 transition-all duration-300">
